...
export default function FramerSpotlight() {
  ...
  // SEION brand spotlight colors matching the logo
  const spotlightColors = [
    { color: "rgba(255, 215, 0, 0.2)", darkColor: "rgba(255, 215, 0, 0.25)" }, // Gold
    { color: "rgba(255, 165, 0, 0.15)", darkColor: "rgba(255, 165, 0, 0.2)" }, // Orange gold
    { color: "rgba(255, 140, 0, 0.15)", darkColor: "rgba(255, 140, 0, 0.2)" }, // Dark orange
  ]
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Additional SEION brand colored spotlights */}
      <motion.div
        className="absolute pointer-events-none"
        initial={{ opacity: 0 }}
        animate={{
        ...
        style={{
          background: `radial-gradient(circle, ${
            isDark ? "rgba(218, 165, 32, 0.2)" : "rgba(218, 165, 32, 0.15)"
          } 0%, transparent 70%)`,
          width: "600px",
          height: "600px",
          borderRadius: "50%",
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle, ${
            isDark ? "rgba(184, 134, 11, 0.2)" : "rgba(184, 134, 11, 0.15)"
          } 0%, transparent 70%)`,
          width: "550px",
          height: "550px",
          borderRadius: "50%",
